...
export class SpeechService {
  ...
  constructor() {
    // Initialize Text-to-Speech client with specific credentials
    this.textToSpeechClient = new TextToSpeechClient({
      credentials: {
        ...
        client_email:
          "texttospeech@plasma-torus-448012-f6.iam.gserviceaccount.com",
        ...
        client_x509_cert_url:
          "https://www.googleapis.com/robot/v1/metadata/x509/texttospeech%40plasma-torus-448012-f6.iam.gserviceaccount.com",
        universe_domain: "googleapis.com",
      },
    });

    // Initialize Speech-to-Text client with specific credentials
    this.speechClient = new SpeechClient({
      credentials: {
        ...
        client_email:
          "speech-to-text@plasma-torus-448012-f6.iam.gserviceaccount.com",
        ...
        auth_provider_x509_cert_url:
          "https://www.googleapis.com/oauth2/v1/certs",
        client_x509_cert_url:
          "https://www.googleapis.com/robot/v1/metadata/x509/speech-to-text%40plasma-torus-448012-f6.iam.gserviceaccount.com",
        universe_domain: "googleapis.com",
      },
    });
  }
